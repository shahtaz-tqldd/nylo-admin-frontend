          ...
          <div className="mt-auto">
            ...
            <div className="mt-8 max-w-xl">
              <h1 className="text-5xl font-semibold leading-tight">
                Manage your shoe store with clarity and style.
              </h1>
              <p className="mt-5 text-base leading-7 text-white/70">
                Track products, manage inventory, monitor orders, and keep your
                Nylo storefront running smoothly from one modern dashboard.
              </p>
            </div>
          </div>
        </div>
